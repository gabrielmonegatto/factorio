...
export const RemotionRoot: React.FC = () => {
    return (
        <>
            ...
            {/* OPTION A: MINIMALISTA CLEAN */}
            <Composition
                id="Treasures-OptionA-Minimalista"
                component={OptionA_Minimalista as any}
                durationInFrames={300}
                fps={30}
                width={1920}
                height={1080}
                defaultProps={{
                    title: "O Tesouro da Fé",
                    subtitle: "Uma meditação sobre promessas divinas",
                    preacherName: "Charles Spurgeon",
                    preacherImage: "https://via.placeholder.com/150?text=Spurgeon",
            ...
            {/* OPTION B: CINEMATIC ÉPICO */}
            <Composition
                id="Treasures-OptionB-Cinematic"
                component={OptionB_Cinematic as any}
                durationInFrames={300}
                fps={30}
                width={1920}
                height={1080}
                defaultProps={{
                    title: "O Tesouro da Fé",
                    subtitle: "Uma meditação poderosa que transforma vidas",
                    preacherName: "Charles Spurgeon",
                    preacherImage: "https://via.placeholder.com/150?text=Spurgeon",
                    frame: 0,
                }}
            ...
            {/* OPTION C: VINTAGE ANTIGO */}
            <Composition
                id="Treasures-OptionC-Vintage"
                component={OptionC_Vintage as any}
                durationInFrames={300}
                fps={30}
                width={1920}
                height={1080}
                defaultProps={{
                    title: "O Tesouro da Fé",
                    subtitle: "Uma meditação sobre as promessas divinas",
                    preacherName: "Charles Spurgeon",
                    preacherImage: "https://via.placeholder.com/150?text=Spurgeon",
                }}
            />

            {/* OPTION D: MODERN BOLD */}
            <Composition
                id="Treasures-OptionD-ModernBold"
                component={OptionD_ModernBold as any}
                durationInFrames={300}
                fps={30}
                width={1920}
                height={1080}
                defaultProps={{
                    title: "O Tesouro da Fé",
                    subtitle: "Uma meditação que transforma e inspira",
                    preacherName: "Charles Spurgeon",
                    preacherImage: "https://via.placeholder.com/150?text=Spurgeon",
                    accentColor: "#00D9FF",
                    frame: 0,
