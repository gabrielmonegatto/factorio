		...
		<div style={{
			...
			<div style={{
				...
				<div style={{
					...
					<img
						src="https://api.qrserver.com/v1/create-qr-code/?size=280x280&data=https://youtube.com/@charlesspurgeontreasures&color=1a0f00&bgcolor=ffffff&qzone=2"
						width={280}
						height={280}
